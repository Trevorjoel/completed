...
<?php
  ...
  while ($row = mysqli_fetch_array($data)) { 
    ...
    echo '<td><a href="removescore.php?id=' . $row['id'] . '&amp;date=' . $row['date'] .
      ...
      if ($row ['approved'] == '0') {
        echo '<td><a href ="approvescore.php?id=' . $row['id'] . '&amp;date=' . $row ['date'] . '&amp;name=' . $row ['name'] . '&amp;score=' . $row ['score'] . '&amp;screenshot=' . $row ['screenshot'] .'">Approve</a>';
 ...
 echo '</table>';
  ...
  mysqli_close($dbc);
?>
<p><a href="addscore.php">add your own score</a>.
<p><a href="index.php">Check the latest high scores.</a></p>
