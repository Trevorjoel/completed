...
<div class="form-group row has-warning">
  ...
  <div class="col-xs-10">
    <input class="form-control form-control-warning" required="required" style="float: left" name="last_name" maxlength="50" size="30" placeholder="Required!" value="<?php  if (isset($_POST['last_name'])) echo strip_tags($_POST['last_name']); ?>">
  </div>
</div>
<div class="form-group row has-warning">
  <label for="email" class="col-xs-2 col-form-label">Email*</label>
  <div class="col-xs-10">
    <input class="form-control form-control-warning" name="email" required="required" maxlength="60" size="30" placeholder="Required!" value="<?php  if (isset($_POST['email'])) echo strip_tags($_POST['email']); ?>" type="text">
  </div>
</div>
<div class="form-group has-warning">
  ...
  <br>
  <input class="form-control form-control-warning" name="bus_name" required="required" placeholder="Required!" value="<?php  if (isset($_POST['bus_name'])) echo strip_tags($_POST['bus_name']); ?>" type="text">
