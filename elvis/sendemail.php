...
<?php
  ...
  if ((!empty($subject)) && (!empty($text))) {
    $dbc = mysqli_connect('localhost', 'root', 'JrpUjMRP2I', 'elvis_store')
...
?>
  ...
  <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <textarea id="elvismail" name="elvismail" rows="8" cols="40"><?php if(isset($_POST['elvismail']))echo $_POST['elvismail']; ?></textarea><br />
